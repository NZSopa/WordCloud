...
# CORS를 처리합니다.Cross-Origin Resource Sharing
...
def process():
    ...
    process_from_text(
        content['text'], content['maxCount'], content['minLength'], words, content['textID'])
    result = {'result': True}
...
if __name__ == '__main__':
    app.run('0.0.0.0', port=5000, threaded=True)  # threaded : 속도 향상
